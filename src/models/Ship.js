 ...
 * @param {object} matrix       - координаты и соостояние корабля
 * @param {Function} createShip - координаты и соостояние корабля
 *
 * this.matrix - избыточная структура.
 * Поле "destroy" - используется для отображения состояния боеспособный корабль или нет.
